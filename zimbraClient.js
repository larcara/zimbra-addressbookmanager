...
function address_book_to_obj(address_book){
	...
	var delegated_folders = address_book.Body.GetFolderResponse.folder[0].link && $.map(address_book.Body.GetFolderResponse.folder[0].link, function(n){return walk_folder(n);});
